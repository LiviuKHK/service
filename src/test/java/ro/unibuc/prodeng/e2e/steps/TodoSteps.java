...
public class TodoSteps {
    ...
    public void createUser(String name, String email) throws Exception {
        ...
        ResponseEntity<String> response =
                restTemplate.postForEntity(BASE_URL + "/api/users", entity, String.class);
    ...
    public void createTodo(String description, String email) throws Exception {
        ...
        // 🔥 IMPORTANT: adaptat la noul constructor (4 câmpuri)
        ...
        latestResponse =
                restTemplate.postForEntity(BASE_URL + "/api/todos", entity, String.class);

        TodoResponse todo =
                objectMapper.readValue(latestResponse.getBody(), TodoResponse.class);
    ...
    public void verifyTodoCount(int count, String email) throws Exception {
        ...
        assertThat(todos.size(), is(count));
    }
    ...
    public void reassignTodo(String newAssigneeEmail) {
        ...
        restTemplate.exchange(
                BASE_URL + "/api/todos/" + lastCreatedTodoId + "/assignee",
                HttpMethod.PATCH,
                entity,
                String.class
        );
    ...
    public void markTodoAsDone() {
        ...
        restTemplate.patchForObject(
                BASE_URL + "/api/todos/" + lastCreatedTodoId + "/done",
                entity,
                String.class
        );
    }
